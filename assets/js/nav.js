...
$(".sidebarMenuuu").html(`
  ...
  <span class="nav-text">Business Owner</span>
</a>
  </li> 
  ...
  <li>
    <a href="agent-management.html" aria-expanded="false">
      <div class="menu-icon">
  ...
  <li>
    <a href="user-management.html" aria-expanded="false">
      <div class="menu-icon">
        <svg id="icon-users" width="22" height="22" viewBox="0 0 24 24" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M16 11C17.6569 11 19 9.65685 19 8C19 6.34315 17.6569 5 16 5C14.3431 5 13 6.34315 13 8C13 9.65685 14.3431 11 16 11Z" fill="#9C99FF"/>
...
const getAdminDetails = async () => {
  ...
  try {
    ...
    document.querySelector(".header-info2 h4").innerText = admin.first_name + " " + admin.last_name || "Admin Name";
